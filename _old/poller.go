...
// 	if err != nil {
// 		n.metrics.PollCyclesTotal.Inc("error")
// 		logger.Errorf("poller: listing zones: %v", err)
// 		return
// 	}
// 	n.metrics.PollCyclesTotal.Inc("success")
...
// 		n.metrics.ZoneSerial.Set(z.Name, z.SOASerial)
// 		n.metrics.CacheSnapshots.Set(z.Name, n.cache.Len(z.Name))
// 	}
// }
...
// 		n.metrics.ZoneSerial.Set(c.Name, serial)
// 		n.metrics.CacheSnapshots.Set(c.Name, n.cache.Len(c.Name))
// 		n.metrics.CatalogMembers.Set(c.Name, catalogMemberCount(c, activeZones))
// 	}
// }
